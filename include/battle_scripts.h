...
extern const u8 BattleScript_SpiderWebEnds[];
...
extern const u8 BattleScript_HarvestedBerry[];
extern const u8 BattleScript_TypeResistBerryHalveDamage[];
...
extern const u8 BattleScript_FocusSashActivates[];
