...
extern const u8 gText_AnotherPkmnAlreadyHoldsItem[];
...
extern const u8 gText_BattleStyleLocked[];
...
extern const u8 gText_NumericalModeRegional[];
...
extern const u8 gText_BackDescription[];
