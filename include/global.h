...
struct SaveBlock1
{
    ...
    /*0x0378*/ struct ItemSlot bagPocket_Items[BAG_ITEMS_COUNT];
    ...
    /*0x069C*/ u16 berryBlenderRecords[3]; // unused
    /*0x06A2*/ u8 unused_632[6];
    /*0x06A8*/ u16 trainerRematchStepCounter;
    /*0x06AA*/ u8 ALIGNED(2) trainerRematches[MAX_REMATCH_ENTRIES];
    /*0x0710*/ struct ObjectEvent objectEvents[OBJECT_EVENTS_COUNT];
    /*0x0950*/ struct ObjectEventTemplate objectEventTemplates[OBJECT_EVENT_TEMPLATES_COUNT];
    /*0x0F50*/ u8 flags[NUM_FLAG_BYTES];
    /*0x1070*/ u16 vars[VARS_COUNT];
    /*0x1270*/ u32 gameStats[NUM_GAME_STATS];
    /*0x1370*/ struct QuestLogScene questLog[QUEST_LOG_SCENE_COUNT];
    /*0x2D10*/ u16 easyChatProfile[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D1C*/ u16 easyChatBattleStart[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D28*/ u16 easyChatBattleWon[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D34*/ u16 easyChatBattleLost[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D40*/ struct Mail mail[MAIL_COUNT];
    /*0x2F80*/ u8 additionalPhrases[NUM_ADDITIONAL_PHRASE_BYTES];
    /*0x2F88*/ OldMan oldMan; // unused
    /*0x2FC4*/ struct DewfordTrend dewfordTrends[5]; // unused
    /*0x2FF0*/ struct DayCare daycare;
    /*0x310C*/ u8 giftRibbons[GIFT_RIBBONS_COUNT];
    /*0x3117*/ struct ExternalEventData externalEventData;
    /*0x312B*/ struct ExternalEventFlags externalEventFlags;
    /*0x3140*/ struct Roamer roamer;
    /*0x315C*/ struct EnigmaBerry enigmaBerry;
    /*0x3190*/ struct MysteryGiftSave mysteryGift;
    /*0x34FC*/ u8 unused_348C[400];
    /*0x368C*/ struct RamScript ramScript;
    /*0x3A78*/ struct RecordMixingGift recordMixingGift; // unused
    /*0x3A88*/ u8 seen2[DEX_FLAGS_NO];
    /*0x3ABC*/ u8 rivalName[PLAYER_NAME_LENGTH + 1];
    /*0x3AC4*/ struct FameCheckerSaveData fameChecker[NUM_FAMECHECKER_PERSONS];
    /*0x3B04*/ u8 unused_3A94[64];
    /*0x3B44*/ u8 registeredTexts[UNION_ROOM_KB_ROW_COUNT][21];
    /*0x3C18*/ struct TrainerNameRecord trainerNameRecords[20];
    /*0x3D08*/ struct DaycareMon route5DayCareMon;
    /*0x3D94*/ u8 unused_3D24[16];
    /*0x3DA4*/ u32 towerChallengeId;
    /*0x3DA8*/ struct TrainerTower trainerTower[NUM_TOWER_CHALLENGE_TYPES];
}; // size: 0x3DD8
