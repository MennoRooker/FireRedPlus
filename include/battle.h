...
struct BattleStruct
{
    ...
    u16 usedHeldItemsByParty[PARTY_SIZE];
...
#define IS_TYPE_PHYSICAL(moveType) \
    ((moveType < TYPE_MYSTERY && moveType != TYPE_GHOST) || (moveType == TYPE_DRAGON) || (moveType == TYPE_DARK))
#define IS_TYPE_SPECIAL(moveType) \
    ((moveType > TYPE_MYSTERY && moveType != TYPE_DRAGON && moveType != TYPE_DARK) || (moveType == TYPE_GHOST))
...
extern u8 gTypeEffectivenessMultiplier;
