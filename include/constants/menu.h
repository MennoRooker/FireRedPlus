...
#define STDSTRING_MEDICINE_POCKET   24
#define STDSTRING_ITEMS_POCKET      25
#define STDSTRING_KEY_ITEMS_POCKET  26
#define STDSTRING_POKEBALLS_POCKET  27
#define STDSTRING_TM_CASE           28
#define STDSTRING_BERRY_POUCH       29
