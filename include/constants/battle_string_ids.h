...
#define STRINGID_PKMNWITHOBLIVIOUSISNOTAFFECTED 200
...
#define STRINGID_PKMNHURTBYSOLARPOWER 390
#define STRINGID_PKMNHARVESTEDBERRY 391
#define STRINGID_PKMNSITEMWEAKENEDTYPEMOVE 392
