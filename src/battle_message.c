...
static const u8 sText_PkmnHurtBySolarPower[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt\nby Solar Power!");
...
static const u8 sText_PkmnWithObliviousIsNotAffected[] = _("{B_DEF_NAME_WITH_PREFIX} is not affected.");
...
static const u8 sText_VeryIneffective[] = _("It's very ineffective…");
...
const u8 gText_ForPetesSake[] = _("OAK: Oh, for Pete's sake…\p{B_PLAYER_NAME}. You've never battled\nwith POKéMON before, have you?\p");
...
const u8 gText_TryBattling[] = _("Try battling and see for yourself.\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNWITHOBLIVIOUSISNOTAFFECTED - BATTLESTRINGS_TABLE_START]= sText_PkmnWithObliviousIsNotAffected,
    ...
    [STRINGID_VERYINEFFECTIVE - BATTLESTRINGS_TABLE_START]               = sText_VeryIneffective,
