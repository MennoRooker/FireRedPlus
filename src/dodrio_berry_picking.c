...
static const u8 sPrizeBerryIds[][10] =
{
    { // Possible prizes with 3 players
        ITEM_TO_BERRY(ITEM_CHILAN_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_OCCA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_PASSHO_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_WACAN_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_RINDO_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_RINDO_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_WACAN_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_PASSHO_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_OCCA_BERRY) - 1,
    ...
    { // Possible prizes with 4 players
        ...
        ITEM_TO_BERRY(ITEM_YACHE_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_CHOPLE_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_KEBIA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_SHUCA_BERRY) - 1
    },
    { // Possible prizes with 5 players
        ITEM_TO_BERRY(ITEM_COBA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_PAYAPA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_TANGA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_CHARTI_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_KASIB_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_KASIB_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_CHARTI_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_TANGA_BERRY) - 1,
        ITEM_TO_BERRY(ITEM_PAYAPA_BERRY) - 1,
