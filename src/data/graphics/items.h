...
const u32 gItemIconPalette_ExpCandyS[] = INCBIN_U32("graphics/items/icon_palettes/exp_candy_s.gbapal.lz");

const u32 gItemIcon_ExpCandyM[] = INCBIN_U32("graphics/items/icons/exp_candy_m.4bpp.lz");
const u32 gItemIconPalette_ExpCandyM[] = INCBIN_U32("graphics/items/icon_palettes/exp_candy_m.gbapal.lz");
