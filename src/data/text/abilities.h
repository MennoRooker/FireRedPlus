...
static const u8 sSpeedBoostDescription[] = _("Boosts SPEED after each turn.");
...
static const u8 sStaticDescription[] = _("May paralyze foe on contact.");
static const u8 sVoltAbsorbDescription[] = _("Restores HP from ELECTRIC-type moves.");
static const u8 sWaterAbsorbDescription[] = _("Restores HP from WATER-type moves.");
static const u8 sObliviousDescription[] = _("Oblivious to infatuation and taunts.");
...
static const u8 sFlashFireDescription[] = _("Ups FIRE-type moves if hit by one.");
static const u8 sShieldDustDescription[] = _("Prevents added effects.");
static const u8 sOwnTempoDescription[] = _("Prevents confusion and intimidation.");
static const u8 sSuctionCupsDescription[] = _("Cannot be forced to switch out.");
static const u8 sIntimidateDescription[] = _("Cuts foe's ATTACK when switching in.");
static const u8 sShadowTagDescription[] = _("Prevents the foe's escape.");
static const u8 sRoughSkinDescription[] = _("Hurts to touch.");
static const u8 sWonderGuardDescription[] = _("Only takes “Super effective” hits.");
static const u8 sLevitateDescription[] = _("Not hit by GROUND attacks.");
static const u8 sEffectSporeDescription[] = _("May status foe on contact.");
static const u8 sSynchronizeDescription[] = _("Passes on status problems.");
static const u8 sClearBodyDescription[] = _("Prevents stats from being lowered.");
static const u8 sNaturalCureDescription[] = _("Heals status problems upon switching.");
static const u8 sLightningRodDescription[] = _("Draws in ELECTRIC-type moves.");
static const u8 sSereneGraceDescription[] = _("Promotes secondary effect chances.");
...
static const u8 sIlluminateDescription[] = _("Raises accuracy and encounter rate.");
static const u8 sTraceDescription[] = _("Copies the foe's ability.");
static const u8 sHugePowerDescription[] = _("Doubles the ATTACK stat.");
static const u8 sPoisonPointDescription[] = _("May poison foe on contact.");
...
static const u8 sSoundproofDescription[] = _("Immune to sound-based moves.");
static const u8 sRainDishDescription[] = _("Recovers HP in rain.");
...
static const u8 sThickFatDescription[] = _("Halves damage from FIRE and ICE moves.");
static const u8 sEarlyBirdDescription[] = _("Awakens quickly from sleep.");
static const u8 sFlameBodyDescription[] = _("May burn foe on contact.");
...
static const u8 sTruantDescription[] = _("Can only attack every other turn.");
static const u8 sHustleDescription[] = _("Raises ATTACK, but lowers accuracy.");
static const u8 sCuteCharmDescription[] = _("May infatuate foe on contact.");
static const u8 sPlusDescription[] = _("Powers up SPATK with MINUS.");
static const u8 sMinusDescription[] = _("Powers up SPATK with PLUS.");
static const u8 sForecastDescription[] = _("Changes forms based on weather.");
static const u8 sStickyHoldDescription[] = _("Prevents item theft.");
static const u8 sShedSkinDescription[] = _("Heals status problems by shedding.");
static const u8 sGutsDescription[] = _("Ups ATTACK if statused.");
static const u8 sMarvelScaleDescription[] = _("Ups DEFENSE if statused.");
static const u8 sLiquidOozeDescription[] = _("Draining moves cause injury.");
static const u8 sOvergrowDescription[] = _("Ups GRASS moves when below half HP.");
static const u8 sBlazeDescription[] = _("Ups FIRE moves when below half HP.");
static const u8 sTorrentDescription[] = _("Ups WATER moves when below half HP.");
static const u8 sSwarmDescription[] = _("Ups BUG moves when below half HP.");
...
static const u8 sWhiteSmokeDescription[] = _("Prevents stats from being lowered.");
static const u8 sPurePowerDescription[] = _("Doubles the ATTACK stat.");
static const u8 sShellArmorDescription[] = _("Blocks critical hits.");
static const u8 sCacophonyDescription[] = _("Immune to sound-based moves.");
