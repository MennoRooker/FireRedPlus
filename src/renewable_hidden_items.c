...
static const struct RenewableHiddenItemData sRenewableHiddenItems[] = {
    ...
    },
    {
        ...
        .uncommon = {
            ...
            HIDDEN_ID(FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_GREEN_SHARD),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_YELLOW_SHARD),
