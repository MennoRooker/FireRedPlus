...
const u8 gText_Regional[] = _("REGIONAL");
...
const u8 gText_NumericalModeRegional[] = _("NUMERICAL MODE: REGIONAL");
...
const u8 gText_NextDataCancel[] = _("{R_BUTTON}NEXT {B_BUTTON}CANCEL");
const u8 gText_Next[] = _("{A_BUTTON}NEXT");
const u8 gText_CancelPreviousData[] = _("{L_BUTTON}PREVIOUS {B_BUTTON}CANCEL");
const u8 gText_PreviousNextCancel[] = _("{L_BUTTON}PREVIOUS {R_BUTTON}NEXT {B_BUTTON}CANCEL");
...
const u8 gText_RepelEffectWoreOff[] = _("REPEL's effect wore off…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AnotherPkmnAlreadyHoldsItem[] = _("Another POKéMON already holds\nthe same ITEM.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnBaseVar2StatDecreased[] = _("{STR_VAR_1}'s {STR_VAR_2}\nstat was lowered.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BottleCapChooseStat[] = _("Maximize the IV\nof which stat?");
const u8 gText_BottleCapMaximizeStat[] = _("Maximize IV of {STR_VAR_2}?");
const u8 gText_BottleCapIVMaximized[] = _("{STR_VAR_1}'s {STR_VAR_2}\nIV was maximized!{PAUSE_UNTIL_PRESS}");
const u8 gText_BottleCapStatAlreadyMax[] = _("{STR_VAR_1}'s {STR_VAR_2}\nIV is already maxed.{PAUSE_UNTIL_PRESS}");
const u8 gText_BottleCapStatHP[] = _("HP");
const u8 gText_BottleCapStatAttack[] = _("Attack");
const u8 gText_BottleCapStatDefense[] = _("Defense");
const u8 gText_BottleCapStatSpAttack[] = _("Sp. Attack");
const u8 gText_BottleCapStatSpDefense[] = _("Sp. Defense");
const u8 gText_BottleCapStatSpeed[] = _("Speed");
...
const u8 gText_Tm26_1500Coins[] = _("TM26{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm30_1800Coins[] = _("TM30{CLEAR_TO 0x48}{FONT_SMALL}1,800 COINS");
const u8 gText_Tm35_1500Coins[] = _("TM35{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
...
const u8 gText_Pinsir_5500Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 COINS");
...
const u8 gText_BackDescription[] = _("Return to the previous menu.");
...
const u8 gText_BattleStyle[] = _("REMATCH ICONS");
...
const u8 gText_BattleStyleShift[] = _("OFF");
const u8 gText_BattleStyleSet[] = _("ON");
