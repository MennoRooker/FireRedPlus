...
graphics/misc/rematch_icon_red.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

graphics/misc/rematch_icon_green.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

graphics/misc/rematch_icon_pink.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

graphics/misc/rematch_icon_purple.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

graphics/misc/rematch_icon_blue.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
